...
# -*- coding: utf-8 -*-
"""
Created on Fri Oct 22 10:40:48 2021
...
mass_star = (1/10)*1.989*10**30
mass_sun = (3/10)*1*1.989*10**30

b_star_ratio = mass_b/mass_star 
b_sun_ratio = mass_b/mass_sun

g_sun = 1.98279e-29*(3/10)*1.989e+30
g_star = 1.98279e-29*(1/10)*1.989e+30
...
b_peri_speed_1 =  17.51




t = np.linspace(0.0, 0.1, num=50000 ) 
t_1 = t*(3.154*10**7)
...
#plt.plot(soln[:, 8], soln[:,10], '#069AF3')
#plt.plot(soln[:, 12], soln[:,14], '')
plt.grid('k')
...
#df1.to_csv('Stars&planet_sim1.csv', index = False)

#rad_vel_habitable = soln_ms

#np.savetxt("data_4_binary.csv", df, delimiter=",")

#df.to_csv('Sim1_30years_Earth.csv', index = False)
