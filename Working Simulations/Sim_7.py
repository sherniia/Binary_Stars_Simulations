...
# -*- coding: utf-8 -*-
"""
Created on Sun Oct 24 11:42:41 2021
...
mass_star = 10*1.989*10**30
mass_sun = 15*1.989*10**30

b_star_ratio = mass_b/mass_star 
b_sun_ratio = mass_b/mass_sun

g_sun = 1.98279e-29*15*1.989e+30
g_star = 1.98279e-29*10*1.989e+30
...
t = np.linspace(0.0, 1000, num=5000 ) 
t_1 = t*(3.154*10**7)

ic = [-sun_pos, 0, 0, -speed_sun_1,
      star_pos, 0, 0, speed_star_1,
      b_pos, 0, 0, b_peri_speed
