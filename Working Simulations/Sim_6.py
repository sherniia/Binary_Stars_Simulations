...
# -*- coding: utf-8 -*-
"""
Created on Wed Nov 10 09:18:19 2021
...
mass_star = 5*1.989*10**30
mass_sun = 5.4*1.989*10**30

b_star_ratio = mass_b/mass_star 
b_sun_ratio = mass_b/mass_sun

g_sun = 1.98279e-29*5.4*1.989e+30
g_star = 1.98279e-29*5*1.989e+30
...
b_peri_speed_1 = 1 # the calculated speed is 1.78



t = np.linspace(0.0, 139, num=5000 ) 
t_1 = t*(3.154*10**7)
...
#df.to_csv('bin_unstable_mass29_20_years.csv', index = False)
